...
function updateTimer() {
  const targetDate = new Date("september 21, 2024 21:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543816105174'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543816105174'; // Número para el primer botón
  const recipientNumber2 = '543814782500'; // Número para el segundo botón
